...
\]
Volgens dezelfde redenering vinden we dat het aantal bits voor het teken, de mantisse en de exponent bij de dubbele-nauwkeurigheidsge
\subsection{Conditie}
\[
\overline{y_1} = \left((1+2x)(1+\epsilon_1)-\left(\frac{1}{(1+x)(1+\epsilon_2)}\right)(1+\epsilon_3)\right)(1+\epsilon_4)
\]tallen respectievelijk $1$, $11$ en $52$ zijn.
