...
Maak zeker ook een tekening, op het examen, van $y=x$ en $y= F(x)$. Begin bij het punt $(x_{0},F(x_{0}))$ en trek een lijn evenwijdig met de horizontale as naar de rechte $y=0$. Trek nu een rechte van het snijpunt waar je bent aangekomen terug naar de grafiek van $y=F(x)$, deze keer evenwijdig met de verticale as. Ga zo door tot je een convergentiepunt bereikt. Het is zo vaak ook makkelijk te zien of er bij een bepaald convergentiepunt divergentie of convergentie optreedt.